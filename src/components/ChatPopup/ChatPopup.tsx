...
export const ChatPopup = () => {
    ...
    return (
      <div className="fixed bottom-24 right-2 md:bottom-8 md:right-8 z-40">
        <Button
          ...
          className="bg-linear-to-br from-[#27A430] to-[#44DB4E] hover:from-[#1b7521] hover:to-[#31a039] text-white rounded-full p-3 transition-gradient hover:transition-gradient duration-500 hover:duration-500 cursor-pointer"
        >
  ...
  return (
    <div className="fixed bottom-24 right-4 md:bottom-8 md:right-20 z-40">
      <div className="bg-linear-to-br from-white via-gray-50 to-white rounded-2xl shadow-2xl w-[calc(100vw-2rem)] h-[calc(100vh-8rem)] md:w-[420px] md:h-[600px] flex flex-col overflow-hidden">
        {/* Header */}
        <div className="bg-linear-to-r from-[#16372d] via-[#1a3d32] to-[#16372d] text-white p-4 md:p-6 rounded-t-2xl flex items-center justify-between shadow-lg">
          <div className="flex items-center space-x-2 md:space-x-3">
            <div className="w-3 h-3 bg-green-400 rounded-full animate-pulse"></div>
            <h3 className="font-bold text-base md:text-lg">{t('chatPopup.formTitle')}</h3>
          </div>
          <button
        ...
        {/* Content */}
        <div className="flex-1 overflow-hidden bg-linear-to-b from-gray-50 to-white">
          <div className="p-4 md:p-6 h-full overflow-y-auto">
            ...
            <form onSubmit={handleSubmit(onSubmit)} className="space-y-3">
              ...
              <Controller
                name="phone"
                control={control}
                render={({ field }) => <PhoneInputComp {...field} error={!!errors?.phone} />}
              />
              ...
              <Checkbox
                ...
                className="flex-wrap gap-x-1 text-sm text-gray-500 hover:text-gray-700"
              />
