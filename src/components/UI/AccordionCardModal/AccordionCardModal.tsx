                        ...
                        <div className="flex flex-col gap-5 flex-1/2">
                            <div className="flex flex-row gap-3 items-center">
                                ...
                                <div className="text-lg font-medium flex flex-col">
                                    <p>{t('hotel.card.rating')}</p>
                                    <p className="text-sm font-normal text-[#2E2E2E]/70">{t('hotel.card.reviews', { count: 200 })}</p>
                                </div>
                            </div>
                        ...
                        {hotel.gallery && (
                            ...
                            >
                                {hotel.gallery.map((image: TourImage) => (
                                    <SwiperSlide key={image.id} className="flex items-center justify-center w-full h-full overflow-hidden rounded-lg">{
                                        <Image
                                            width={800}
                                            height={600}
                                            loading="lazy"
