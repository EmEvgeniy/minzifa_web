    ...
    return (
        ...
        >
            ...
            <div className="flex flex-row gap-2.5 items-center">
                <button
                    className={cn(value <= min ? "disabled:cursor-not-allowed" : "cursor-pointer", "flex items-center justify-center w-10 h-10 bg-[#16372D] text-white rounded-lg disabled:opacity-50")}
                    onClick={decrement}
                    disabled={value <= min}
                >
                    <FaMinus />
