...
export const AccomodationCard = ({ hotel, openModal, setOpenModal, setSelectedHotel }: AccomodationCardProps) => {
    ...
    return (
        <>
            ...
            } className="w-full h-full rounded-2xl bg-white flex flex-col items-start justify-start text-xl font-semibold overflow-hidden">
