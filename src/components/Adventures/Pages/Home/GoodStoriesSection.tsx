...
export default function GoodStoriesSection({ mainArticles, gridArticles, title, viewAllText }: Props) {
        ...
        <div className="mb-16">
            ...
            <div className="space-y-8">
                ...
                <div className="flex justify-end mt-4">
                    <Link href={`/${locale}/prototype/adventures/stories`} className="flex items-center gap-1 text-[11px] font-bold text-gray-500 hover:text-foreground transition-colors uppercase tracking-[0.2em]">
