...
export default function GoodTripsSection({ articles, title, viewAllText }: Props) {
    ...
    return (
        <div className="mb-16">
            ...
            <div className="flex justify-end mt-8">
                <Link href={`/${locale}/prototype/adventures/trips`} className="flex items-center gap-1 text-[11px] font-bold text-gray-500 hover:text-foreground transition-colors uppercase tracking-[0.2em]">
