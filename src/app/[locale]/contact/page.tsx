...
export default function page() {
  return (
    <section className="bg-[#16372D] w-full relative min-h-[90svh] h-full flex items-center justify-center py-[20%] max-[1024px]:min-h-[100svh] max-[768px]:py-[12%] max-[550px]:pt-[30%]">
